...
public class Exe08 extends HttpServlet {
	private String enunciado = "08) Um vendedor necessita de um algoritmo que calcule o preço total devido por um cliente. O algoritmo deve receber <BR />o código de um produto e a quantidade comprada e calcular o preço total, usando a tabela abaixo: <BR />Código do produto | Preço unitário <BR /> 1001 | R$ 5,32 <BR /> 1324 | R$ 6,45 <BR /> 6548 | R$ 2,37 <BR /> 0987 | R$ 5,32 <BR /> 7623 | R$ 6,45";
	private String title = "Exercicio 08";
